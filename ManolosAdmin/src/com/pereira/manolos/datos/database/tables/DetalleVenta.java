...
public class DetalleVenta extends TableImpl<DetalleVentaRecord> {
    ...
    private static final long serialVersionUID = -1810899606;
     ...
     */
    public final TableField<DetalleVentaRecord, Integer> CANTIDAD = createField("cantidad", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    /**
     * The column <code>public.detalle_venta.tipo</code>.
     */
    public final TableField<DetalleVentaRecord, String> TIPO = createField("tipo", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.detalle_venta.espromo</code>.
     */
    public final TableField<DetalleVentaRecord, Boolean> ESPROMO = createField("espromo", org.jooq.impl.SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>public.detalle_venta.idpromocion</code>.
     */
    public final TableField<DetalleVentaRecord, Integer> IDPROMOCION = createField("idpromocion", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    public List<ForeignKey<DetalleVentaRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DetalleVentaRecord, ?>>asList(Keys.DETALLE_VENTA__FK_DETALLE_VENTA_VENTA, Keys.DETALLE_VENTA__FK_DETALLE_VENTA_PRODUCTO_1, Keys.DETALLE_VENTA__FK_DETALLE_VENTA_PROMOCION_1);
    }
