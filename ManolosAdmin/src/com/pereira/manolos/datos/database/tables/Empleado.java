...
public class Empleado extends TableImpl<EmpleadoRecord> {
    ...
    private static final long serialVersionUID = 949831746;
    ...
    /**
     * The column <code>public.empleado.idpuesto</code>.
     */
    public final TableField<EmpleadoRecord, Integer> IDPUESTO = createField("idpuesto", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    public List<ForeignKey<EmpleadoRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<EmpleadoRecord, ?>>asList(Keys.EMPLEADO__FK_EMPLEADO_PUESTO_1);
    }
