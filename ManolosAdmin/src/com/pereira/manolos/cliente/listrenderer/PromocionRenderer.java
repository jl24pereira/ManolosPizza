...
/* @author JL Desk */
public class PromocionRenderer extends JPanel implements ListCellRenderer<ModeloPromocion> {
    ...
    private static final Logger LOG = Logger.getLogger ( PromocionRenderer.class.getName () );

    public PromocionRenderer () {
        initComponents ();
    }

    @Override
    public Component getListCellRendererComponent ( JList<? extends ModeloPromocion> jlist , ModeloPromocion e , int i , boolean isSelected ,
                                                    boolean bln1 ) {
