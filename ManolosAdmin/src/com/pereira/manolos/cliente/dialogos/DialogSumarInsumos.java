...
public class DialogSumarInsumos extends javax.swing.JDialog {

    private final DAOManager manager;
    private ModeloInsumo insumo;
    private boolean complete = true;

    public DialogSumarInsumos ( java.awt.Frame parent , boolean modal , String titulo , DAOManager pManager, ModeloInsumo insumo ) {
        super ( parent , modal );
        ...
        this.insumo = insumo;
        this.txtStockActual.setText(""+insumo.getStock());
        this.sumarInsumos();
    }

//    public DialogSumarInsumos ( java.awt.Frame parent , boolean modal , String titulo , DAOManager pManager , ModeloCostosIndirectos pCostosIndirectos ) {
//        super ( parent , modal );
//        this.manager = pManager;
...
//    }
    ...
    private void initComponents() {
        ...
        spSuma = new javax.swing.JSpinner();
        ...
        txtStockFinal = new javax.swing.JLabel();
        ...
        spSuma.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        spSuma.setModel(new javax.swing.SpinnerNumberModel(0.0d, null, null, 5.0d));
        spSuma.setBorder(javax.swing.BorderFactory.createLineBorder(colorUI, 2));
        spSuma.setMinimumSize(new java.awt.Dimension(100, 40));
        spSuma.setPreferredSize(new java.awt.Dimension(100, 40));
        spSuma.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                spSumaStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        jPanel5.add(spSuma, gridBagConstraints);
        spSuma.setUI(new SpinnerUI(colorBG,colorUI,colorUI));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pereira/manolos/cliente/images/Material Icons_e85d(0)_64.png"))); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        txtStockActual.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        jPanel5.add(txtStockActual, gridBagConstraints);

        txtStockFinal.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        jPanel5.add(txtStockFinal, gridBagConstraints);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        this.insumo.setStock(Double.parseDouble(this.txtStockFinal.getText()));
        try {
            this.manager.getInsumoDAO().modificar(insumo);
            Mensajes.mensajeOk ( "Registro editado satisfactoriamente!" );
        } catch (Exception ex) {
            Mensajes.mensajeError ( "Error al editar Insumo!" );
            Logger.getLogger(DialogSumarInsumos.class.getName()).log(Level.SEVERE, null, ex);
        } finally{
            this.dispose();
        }
    ...
    private void spSumaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spSumaStateChanged
        this.sumarInsumos();
    }//GEN-LAST:event_spSumaStateChanged
    ...
    private javax.swing.JSpinner spSuma;
    private javax.swing.JLabel txtStockActual;
    private javax.swing.JLabel txtStockFinal;
    ...
    private void sumarInsumos(){
        Double total = Double.parseDouble(this.txtStockActual.getText())+Double.parseDouble(this.spSuma.getValue().toString());
        this.txtStockFinal.setText(""+total);
    }

    private static final Logger LOG = Logger.getLogger (DialogSumarInsumos.class.getName () );
