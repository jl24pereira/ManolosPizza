...
public class Fechero {
    ...
    public static java.util.Date baseToDateTimeStamp(java.sql.Timestamp fecha) {
        java.util.Date date = new java.util.Date(fecha.getTime());
        return date;
    }

    public static java.util.Date baseToDate(java.sql.Date fecha) {
        return new java.util.Date(fecha.getTime());
    }

    public static java.sql.Date dateToBase(java.util.Date fecha) {
