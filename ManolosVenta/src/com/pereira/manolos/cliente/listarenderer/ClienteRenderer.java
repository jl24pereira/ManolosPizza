...
/* @author JL Desk */
public class ClienteRenderer extends JPanel implements ListCellRenderer<ModeloCliente> {
    ...
    private static final Logger LOG = Logger.getLogger ( ClienteRenderer.class.getName () );
}
