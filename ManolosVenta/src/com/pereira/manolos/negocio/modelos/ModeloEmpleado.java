...
public class ModeloEmpleado {
    ...
    public ModeloEmpleado ( int pIdempleado , String pNombre , String pTelefono ,
                            String pDireccion , String pEmail , String pDUI ,
                            String pNIT , ModeloPuesto pPuesto , boolean pBaja ) {
    ...
    public ModeloEmpleado ( String pNombre , String pTelefono ,
                            String pDireccion , String pEmail , String pDUI ,
                            String pNIT , ModeloPuesto pPuesto ) {
        this.vNombre = pNombre;
        this.vTelefono = pTelefono;
        this.vDireccion = pDireccion;
        this.vEmail = pEmail;
