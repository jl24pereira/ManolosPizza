...
public class ModeloCotizacion {
    ...
    public ModeloCotizacion ( int pIdcotizacion , String pNumero , Date pFecha ,
                              ModeloCliente pCliente , ModeloEmpleado pEmpleado ,
                              Date pEncimiento , BigDecimal pTotal ,
                              String pEnletras , int pAlidapor ) {
    ...
    public ModeloCotizacion ( int pIdcotizacion , String pNumero , Date pFecha ,
                              ModeloCliente pCliente , ModeloEmpleado pEmpleado ,
                              BigDecimal pTotal , String pEnletras ) {
        this.idcotizacion = pIdcotizacion;
        this.numero = pNumero;
        this.fecha = pFecha;
        this.vCliente = pCliente;
    ...
    public ModeloCotizacion ( String pNumero , Date pFecha ,
                              ModeloEmpleado pEmpleado ) {
        this.numero = pNumero;
        this.fecha = pFecha;
        this.vEmpleado = pEmpleado;
    }
