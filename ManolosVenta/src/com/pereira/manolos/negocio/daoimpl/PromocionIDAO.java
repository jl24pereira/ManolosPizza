    ...
    public List<ModeloPromocion> obtenerLista ( Condition c ) throws Exception {
        ...
        records.forEach ( r -> {
            ...
            switch ( hoy.get ( Calendar.DAY_OF_WEEK ) ) {
                case 2:
                    if ( r.getValue ( PROMOCION.LUNES ) ) {
                        aplica = true;
                    }
                    break;
                case 3:
                    if ( r.getValue ( PROMOCION.MARTES ) ) {
                        aplica = true;
                    }
                    break;
                case 4:
                    if ( r.getValue ( PROMOCION.MIERCOLES ) ) {
                        aplica = true;
                    }
                    break;
                case 5:
                    if ( r.getValue ( PROMOCION.JUEVES ) ) {
                        aplica = true;
                    }
                    break;
                case 6:
                    if ( r.getValue ( PROMOCION.VIERNES ) ) {
                        aplica = true;
                    }
                    break;
                case 7:
                    if ( r.getValue ( PROMOCION.SABADO ) ) {
                        aplica = true;
                    }
                    break;
                default:
                    if ( r.getValue ( PROMOCION.DOMINGO ) ) {
                        aplica = true;
                    }
                    break;
            }
