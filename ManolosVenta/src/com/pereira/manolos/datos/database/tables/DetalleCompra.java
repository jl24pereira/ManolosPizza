...
public class DetalleCompra extends TableImpl<DetalleCompraRecord> {
    ...
    private static final long serialVersionUID = 160529177;
    ...
    /**
     * The column <code>public.detalle_compra.idinsumo</code>.
     */
    ...
    /**
     * The column <code>public.detalle_compra.precio</code>.
     */
    public final TableField<DetalleCompraRecord, BigDecimal> PRECIO = createField("precio", org.jooq.impl.SQLDataType.NUMERIC.precision(7, 4), this, "");
    ...
    public List<ForeignKey<DetalleCompraRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DetalleCompraRecord, ?>>asList(Keys.DETALLE_COMPRA__FK_DETALLE_COMPRA_COMPRA_1, Keys.DETALLE_COMPRA__FK_DETALLE_COMPRA_INSUMO_1);
    }
